...
Namespace data.dao
    Public Class OleDBConnectionObj
        ...
        Protected connection As data.dao.ConnectionsProperty
        ...
        Public Sub New()
            ...
            For Each s As String In System.Configuration.ConfigurationSettings.AppSettings
                If s.Contains("DB-") Then
                    cont = True
                    Dim con As New data.dao.ConnectionsProperty
                    con.Name = s
        ...
        Public Sub New(ByVal ConnectionProperty As data.dao.ConnectionsProperty)
